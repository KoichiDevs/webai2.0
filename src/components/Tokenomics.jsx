        ...
        <>
            <section className='w-full h-auto bg-tokenbg md:px-20 px-10 pt-28  text-white relative bg-token bg-cover bg-center' id="tokenomics">
                <div className='lg:flex-row flex-col flex justify-between'>
                    ...
                    <div className='w-full h-auto flex items-top lg:justify-center z-10 relative mt-10 lg:mt-0'>

                        <div className='w-fit h-auto font-saira text-2xl 2xl:text-9xltop'>
                            <h1 className='text-center font-bold md:text-5xl 2xl:text-7xl'>TOTAL TAX <span className='text-header font-bold lg:text-center'>3%</span></h1>
                            <div className='mt-8 flex flex-col gap-y-4 font-poppins 2xl:text-lg ml-10'>
                            <p><span className='text-2xl  font-saira font-bold 2xl:text-3xl'>1% </span> Further development of WebAI ecosystem</p>
                            <p><span className='text-2xl  font-saira font-bold 2xl:text-3xl'>2% </span> Strategic marketing of WebAI token and ecosystem</p>
                        </div> 
                        </div>
                        
                    </div>
                </div>
                <div className='max-h-[25rem] w-fullflex items-center justify-between mx-auto lg:flex-row flex-col gap-y-10'>
