                ...
                <section className='w-full h-screen bg-heroblue relative text-white overflow-hidden'>
                    ...
                    <div className='w-full max-w-[1700px] mx-auto flex items-center h-full lg:px-20 z-10 relative text-center lg:text-left justify-center lg:justify-start'>
                        <div className=''>
                            ...
                            <motion.div initial={{ x: -200, opacity: 0 }} animate={{ x: 0, opacity: 100 }} transition={{ duration: 1, delay: 0.05 }} className='flex lg:text-xl text-xl font-bold mt-6 font-saira gap-x-[7px] mx-auto w-fit lg:mx-0 lg:w-auto min-w-[22rem] items-center justify-center lg:justify-start'>
                                <h2 className='hidden'>Contract Address</h2>
                                <div className='text-header'>
                                    <Typewriter
                                        options={{
                                            strings: ['0x3Bc0f4F178666311F51e028FC3C1d5b561cB1dF6'],
                                            autoStart: true,
                                            loop: true,
                                        }}
                                    />
